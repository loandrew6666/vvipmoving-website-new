...
import { BRAND, PRICING_KAOHSIUNG } from "@/lib/brandData";

export default function PricingKaohsiung() {
  const p = PRICING_KAOHSIUNG;
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 bg-gradient-to-br from-secondary to-background">
        <div className="container text-center">
          <Badge className="bg-brand-dark text-white mb-4 px-4 py-1">高雄地區</Badge>
      ...
      <section className="py-12 bg-white">
        <div className="container max-w-4xl">
          ...
          <div className="bg-gradient-to-r from-brand-dark to-brand rounded-2xl p-8 text-white text-center">
            <h2 className="text-2xl font-bold mb-4">高雄地區立即預約</h2>
            <p className="text-white/80 mb-6">彰化以南地區，歡迎透過 LINE 或電話預約估價</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={BRAND.bookingUrls.kaohsiung} target="_blank" rel="noopener noreferrer">
                <Button size="lg" className="bg-white text-brand-dark hover:bg-secondary font-bold rounded-full px-8">
